...
export const TEXT_PRESETS: Record<TextPresetCategory, TextPreset[]> = {
  ...
  curio_favorites: mk("cufav", [
    ...
    "🏅 Salva essa curiosidade para contar depois 📌",
    "⭐ Poucas pessoas sabem dessa informação 🔥",
    "🎖️ Espera até o final porque isso muda tudo ⚠️",
    "🏆 Essa informação parece mentira, mas é real 🤯",
    "✨ Envia para aquele amigo que ama aprender coisas novas 🧠",
    "💥 Aposto que você nunca ouviu isso antes 👀",
    "🔝 De 0 a 10, quanto você já sabia disso? ⚡",
  ]),
  curio_friends: mk("cufr", [
    ...
    "📢 Duvido seu amigo saber dessa... manda pra ele",
    "👥 Marca aquele amigo que vive dizendo que sabe de tudo",
    "📤 Envia para quem gosta de curiosidade aleatória",
    "🤓 Compartilha com quem adora ganhar discussão com fato",
    "💬 Manda no grupo e vê quem já sabia disso",
    "👀 Marca alguém que vai ler isso duas vezes",
    "🚀 Envia para aquele amigo curioso demais",
    "😲 Manda para alguém que precisa parar e pensar nisso",
    "📱 Compartilha com quem vive falando de curiosidades",
    "🧩 Marca aquele amigo que ama descobrir coisas escondidas",
    "🔎 Envia para quem gosta de investigar tudo",
    "📚 Manda para aquele amigo que ama conhecimento inútil",
    "🤝 Compartilha com quem vai comentar 'não sabia disso'",
    "🎯 Marca alguém que vai querer confirmar se é verdade",
  ]),
  curio_comment: mk("cucm", [
    ...
    "🤨 Você acredita nessa informação?",
    "🗣️ Conta aí: você já tinha ouvido isso?",
    "👇 Qual parte te deixou sem entender nada?",
    "🧐 Você conhece outra curiosidade parecida?",
    "😳 Isso mudou o que você pensava sobre o assunto?",
    "📝 Comenta uma curiosidade que poucos sabem",
    "🤯 Essa foi a mais surpreendente que você já viu?",
    "👀 Você teria coragem de testar isso?",
    "🔍 Alguém aqui já sabia o motivo disso?",
    "💡 Você entendeu de primeira?",
    "🤔 Verdade ou lenda? Comenta aí",
    "📊 Quantas pessoas aqui já sabiam disso?",
  ]),
  curio_challenge: mk("cuch", [
    ...
    "🎯 Duvido você chegar até o fim sem se surpreender",
    "🧩 Só 1 em cada 10 pessoas sabe responder isso",
    "⏳ Tenta adivinhar antes de eu falar",
    "🔒 Essa informação quase ninguém consegue explicar",
    "🚀 Se você acertar, comenta que você sabia",
    "👁️ Duvido você perceber o detalhe escondido",
    "🥶 Aposto que isso vai travar sua cabeça",
    "📌 Só quem assistir até o final vai entender",
    "🤨 Você consegue provar que isso é falso?",
    "🏁 Desafio: explica isso para alguém depois",
  ]),
  curio_viral: mk("cuvr", [
    ...
    "🚨 Isso está bem na sua frente e você nunca notou",
    "🧠 Sua cabeça não vai processar isso de primeira",
    "😵 Essa é daquelas que ninguém acredita",
    "📈 Isso explica muita coisa que você via por aí",
    "👁️ Depois de saber disso, não tem como desver",
    "⚡ Poucas informações são tão estranhas quanto essa",
    "🌍 O mundo esconde detalhes assim o tempo todo",
    "🔓 Essa é a curiosidade que ninguém te contou",
    "💾 Salva antes que o vídeo suma do seu feed",
    "🎬 Assiste até o final que fica ainda mais estranho",
  ]),
  real_favorites: mk("hrfav", [
    ...
    "🎖️ Poucos esperavam esse final 🚨",
    "🏆 O que você faria nessa situação? 👀",
    "✨ Salva essa história para lembrar depois 📌",
    "💥 A realidade sempre surpreende ⚠️",
  ...
  real_friends: mk("hrfr", [
    ...
    "📤 Envia essa história para o grupo agora",
    "🔥 Marca aquele amigo que ama caso real",
    "🗣️ Compartilha com quem vai querer comentar sobre isso",
    "👥 Manda para alguém que já viveu algo parecido",
    "📱 Envia para quem precisa saber que isso aconteceu",
    "🤯 Marca aquele amigo que vai dizer que é mentira",
    "💬 Compartilha com quem gosta de história de arrepiar",
    "🎯 Manda para alguém que precisa ouvir esse final",
  ]),
  real_comment: mk("hrcm", [
    ...
    "😳 Você teria a mesma coragem?",
    "👇 Comenta o que você achou desse final",
    "🤨 Isso poderia acontecer com qualquer um?",
    "📝 Qual parte dessa história te chocou mais?",
    "😱 Você aguentaria passar por isso?",
    "🧠 O que você faria diferente?",
    "⚖️ Você acha que foi sorte ou coincidência?",
    "🔍 Alguém aqui conhece um caso assim?",
    "👀 Você já ouviu essa história antes?",
    "💭 Como você reagiria no lugar dessa pessoa?",
  ]),
  real_curiosity: mk("hrcu", [
    ...
    "😳 Tudo mudou por causa de um detalhe",
    "🧩 Ninguém percebeu o que estava acontecendo",
    "📖 Essa história real parece roteiro de filme",
    "🕵️ O detalhe que mudou tudo passou despercebido",
    "⏳ Demorou anos para descobrirem a verdade",
    "🤯 O final dessa história ninguém previu",
    "🔎 Uma coincidência que ninguém consegue explicar",
    "😶 O que aconteceu depois foi ainda mais estranho",
  ]),
  real_viral: mk("hrvr", [
    "😱 Espera até o final dessa história",
    ...
    "🎬 Parece ficção, mas é um caso real",
    "😵 Os últimos segundos mudam tudo",
    "💾 Guarda essa história para contar depois",
    "⚡ Assiste até o fim que fica pior",
    "👁️ Ninguém esperava esse desfecho",
    "🧊 Essa história ainda dá arrepio",
    "📢 Uma das histórias reais mais impressionantes",
  ]),
};
