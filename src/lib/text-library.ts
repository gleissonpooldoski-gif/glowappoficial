...
export const TEXT_PRESETS: Record<TextPresetCategory, TextPreset[]> = {
  ...
  bio_produtos: mk("bprod", [
    "🛍️ Os melhores achadinhos estão na bio.",
    "✨ Produto aprovado! Confira na bio.",
    "🔥 Esse produto está fazendo sucesso. Veja a bio.",
    "👀 Quer ver mais produtos assim? Confira a bio.",
    "💸 Achadinhos que realmente valem a pena estão na bio.",
    "🎁 Produtos selecionados esperando por você na bio.",
    "⭐ Os links dos produtos estão na bio.",
    "🛒 Gostou? Veja os produtos na bio.",
    "💥 Os produtos mais pedidos estão na bio.",
    "📦 Confira todos os achadinhos na bio.",
  ]),
  memes_comment: mk("mc", [
